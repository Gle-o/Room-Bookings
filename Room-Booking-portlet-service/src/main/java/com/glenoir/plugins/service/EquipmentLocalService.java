...
/**
 * Provides the local service interface for Equipment. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author guillaume Lenoir
 * @see EquipmentLocalServiceUtil
 * @see com.glenoir.plugins.service.base.EquipmentLocalServiceBaseImpl
 * @see com.glenoir.plugins.service.impl.EquipmentLocalServiceImpl
 * @generated
 */
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
    PortalException.class, SystemException.class}
)
public interface EquipmentLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link EquipmentLocalServiceUtil} to access the equipment local service. Add custom service methods to {@link com.glenoir.plugins.service.impl.EquipmentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
