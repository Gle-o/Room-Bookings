...
/**
 * Provides the local service interface for EquipmentType. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author guillaume Lenoir
 * @see EquipmentTypeLocalServiceUtil
...
public interface EquipmentTypeLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link EquipmentTypeLocalServiceUtil} to access the equipment type local service. Add custom service methods to {@link com.glenoir.plugins.service.impl.EquipmentTypeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
