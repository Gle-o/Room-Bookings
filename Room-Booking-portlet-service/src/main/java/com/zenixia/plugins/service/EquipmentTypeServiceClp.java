...
public class EquipmentTypeServiceClp implements EquipmentTypeService {
    ...
    public EquipmentTypeServiceClp(InvokableService invokableService) {
        ...
        _methodName4 = "updateEquipmentType";
        ...
        _methodName5 = "deleteEquipmentType";

        _methodParameterTypes5 = new String[] { "long" };

        _methodName6 = "getEquipmentType";

        _methodParameterTypes6 = new String[] { "long" };

        _methodName7 = "getEquipmentTypeByGroupId";

        _methodParameterTypes7 = new String[] { "long" };

        _methodName8 = "getEquipmentTypeByGroupId";

        _methodParameterTypes8 = new String[] { "long", "int", "int" };

        _methodName9 = "getEquipmentCountTypeByGroupId";
    ...
    public com.zenixia.plugins.model.EquipmentType deleteEquipmentType(
        ...
        try {
            returnObj = _invokableService.invokeMethod(_methodName5,
                    _methodParameterTypes5, new Object[] { equipmentTypeId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.zenixia.plugins.model.EquipmentType getEquipmentType(
        ...
        try {
            returnObj = _invokableService.invokeMethod(_methodName6,
                    _methodParameterTypes6, new Object[] { equipmentTypeId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
