...
public class EquipmentServiceClp implements EquipmentService {
    ...
    public EquipmentServiceClp(InvokableService invokableService) {
        ...
        _methodName5 = "deleteEquipment";

        _methodParameterTypes5 = new String[] { "long" };

        _methodName6 = "getEquipment";

        _methodParameterTypes6 = new String[] { "long" };

        _methodName7 = "getEquipmentByGroupId";

        _methodParameterTypes7 = new String[] { "long" };

        _methodName8 = "getEquipmentByGroupId";

        _methodParameterTypes8 = new String[] { "long", "int", "int" };

        _methodName9 = "getEquipmentCountByGroupId";

        _methodParameterTypes9 = new String[] { "long" };

        _methodName10 = "getEquipmentByGroupIdEquipementTypeId";
    ...
    public com.zenixia.plugins.model.Equipment deleteEquipment(long equipmentId)
        ...
        try {
            returnObj = _invokableService.invokeMethod(_methodName5,
                    _methodParameterTypes5, new Object[] { equipmentId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.zenixia.plugins.model.Equipment getEquipment(long equipmentId)
        ...
        try {
            returnObj = _invokableService.invokeMethod(_methodName6,
                    _methodParameterTypes6, new Object[] { equipmentId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.zenixia.plugins.model.Equipment> getEquipmentByGroupId(
        ...
        try {
            returnObj = _invokableService.invokeMethod(_methodName8,
                    _methodParameterTypes8, new Object[] { groupId, start, end });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
