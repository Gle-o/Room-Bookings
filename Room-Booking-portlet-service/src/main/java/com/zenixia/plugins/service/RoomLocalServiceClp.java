...
public class RoomLocalServiceClp implements RoomLocalService {
    ...
    public com.zenixia.plugins.model.Room addRoom(
        ...
        return (com.zenixia.plugins.model.Room) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.zenixia.plugins.model.Room getRoom(long roomId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName13,
                    _methodParameterTypes13, new Object[] { roomId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.zenixia.plugins.model.Room> getRooms(int start,
        ...
        return (java.util.List<com.zenixia.plugins.model.Room>) ClpSerializer.translateOutput(returnObj);
    }
