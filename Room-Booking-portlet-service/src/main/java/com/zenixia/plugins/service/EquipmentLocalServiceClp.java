...
public class EquipmentLocalServiceClp implements EquipmentLocalService {
    ...
    public EquipmentLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName25 = "getEquipmentCountByEquipmentTypeId";

        _methodParameterTypes25 = new String[] { "long" };

        _methodName26 = "getEquipmentByEquipmentTypeIdRoomId";

        _methodParameterTypes26 = new String[] { "long", "long" };

        _methodName27 = "getAvailableEquipmentByGroupIdEquipementTypeId";

        _methodParameterTypes27 = new String[] { "long", "long" };

        _methodName28 = "getEquipmentByRoomId";
    ...
    public com.zenixia.plugins.model.Equipment addEquipment(
        ...
        return (com.zenixia.plugins.model.Equipment) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.zenixia.plugins.model.Equipment getEquipment(long equipmentId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName13,
                    _methodParameterTypes13, new Object[] { equipmentId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.zenixia.plugins.model.Equipment> getEquipments(
        ...
        return (java.util.List<com.zenixia.plugins.model.Equipment>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.zenixia.plugins.model.Equipment addEquipment(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName23,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(equipment),
    ...
    public int getEquipmentCountByEquipmentTypeId(long equipmentTypeId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName25,
                    _methodParameterTypes25, new Object[] { equipmentTypeId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.zenixia.plugins.model.Equipment> getEquipmentByEquipmentTypeIdRoomId(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName26,
                    ...
                    new Object[] { equipmentTypeId, roomId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.zenixia.plugins.model.Equipment> getAvailableEquipmentByGroupIdEquipementTypeId(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName27,
                    ...
                    new Object[] { groupId, equipmentTypeId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
