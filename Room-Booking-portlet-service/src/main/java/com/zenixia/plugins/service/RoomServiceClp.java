...
public class RoomServiceClp implements RoomService {
    ...
    public RoomServiceClp(InvokableService invokableService) {
        ...
        _methodName5 = "deleteRoom";

        _methodParameterTypes5 = new String[] { "long" };

        _methodName6 = "getRoom";

        _methodParameterTypes6 = new String[] { "long" };

        _methodName7 = "getRoomByGroupId";

        _methodParameterTypes7 = new String[] { "long" };

        _methodName8 = "getRoomByGroupId";

        _methodParameterTypes8 = new String[] { "long", "int", "int" };

        _methodName9 = "getRoomCountByGroupId";
