...
public class EquipmentTypeWrapper implements EquipmentType,
    ...
    */
    ...
    /**
    * Returns the group ID of this equipment type.
    *
    * @return the group ID of this equipment type
    */
    @Override
    public long getGroupId() {
        return _equipmentType.getGroupId();
    }

    /**
    * Sets the group ID of this equipment type.
    *
    * @param groupId the group ID of this equipment type
    */
    @Override
    public void setGroupId(long groupId) {
        _equipmentType.setGroupId(groupId);
    }
